...
| traefik.apiVersion                   | traefik.io/v1alpha1 | From version **0.10.3** on, uitsmijter supports difefrent traefik crd versions. If you are still on traefik 2, you have to set `traefik.containo.us/v1alpha1` otherwise leave blank.            |
